...
# 
# #### 请将你的答案填写在下方
# - 模型在预测的准确性上还存在一定的差异，经过多次的模型训练，对迭代次数，学习率和隐藏节点数都进行了优化，迭代次数主要在3000-5000区间进行优化，学习率在0.5-0.8之间进行选择，隐藏节点数在15-25区间进行选择，最终选择迭代次数为3000，学习率为0.8，隐藏节点数为15，结果显示这样的参数选择在计算时间和验证数据集的拟合情况下较好的选择
